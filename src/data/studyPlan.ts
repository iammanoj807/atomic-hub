...
/** Hours a normal week asks for. The Daily Routine slots add up to exactly this. */
...
export const workPattern = 'Work: Mon-Thu 10:00-18:00  |  FRIDAY OFF  |  Sat & Sun 10:00-14:00';
...
// ============ DAILY ROUTINE — the same every week for 26 weeks ============

export interface RoutineSlot {
    day: string;
    time: string;
    /** null for the Friday rest block, which has no hours by design. */
    hours: number | null;
    track: string;
    what: string;
    why: string;
...
export const dailyRoutine: RoutineSlot[] = [
    { day: 'Monday', time: '06:30-08:30', hours: 2, track: 'A - Theory', what: 'Maths / theory. WATCH video, then READ, then work problems.', why: 'Brain is freshest before work' },
    { day: 'Monday', time: '19:30-20:15', hours: 0.75, track: 'B - DSA', what: '1 NeetCode problem. Watch the video AFTER you try it.', why: 'Puzzles work fine on a tired brain' },
    { day: 'Tuesday', time: '06:30-08:30', hours: 2, track: 'A - Theory', what: 'Maths / theory', why: 'Brain freshest' },
    { day: 'Tuesday', time: '19:30-20:15', hours: 0.75, track: 'B - DSA', what: '1 NeetCode problem', why: 'Daily habit - never skip' },
    { day: 'Wednesday', time: '06:30-08:30', hours: 2, track: 'A - Theory', what: 'Maths / theory', why: 'Brain freshest' },
    { day: 'Wednesday', time: '19:30-20:15', hours: 0.75, track: 'B - DSA', what: '1 NeetCode problem', why: 'Daily habit' },
    { day: 'Thursday', time: '06:30-08:30', hours: 2, track: 'A - Theory', what: 'Maths / theory', why: 'Brain freshest' },
    { day: 'Thursday', time: '19:30-20:15', hours: 0.75, track: 'B - DSA', what: '1 NeetCode problem', why: 'Daily habit' },
    { day: 'FRIDAY', time: '09:00-15:00', hours: 5, track: 'A + B - BUILD', what: 'DEEP WORK. Building things from scratch. The most valuable 5 hours of your week.', why: 'Your only full day - this is the anchor' },
    { day: 'FRIDAY', time: '15:00 on', hours: null, track: 'REST', what: 'Nothing. Stop completely.', why: 'No rest = you quit by week 8' },
    { day: 'Saturday', time: '15:00-18:30', hours: 3.5, track: 'B - AI Eng', what: 'LLM systems, RAG, evals, deployment. Project work.', why: 'After your 10-2 shift' },
    { day: 'Saturday', time: '20:00-20:45', hours: 0.75, track: 'B - DSA', what: '1 NeetCode problem', why: 'Daily habit' },
    { day: 'Sunday', time: '15:00-18:00', hours: 3, track: 'A - Papers', what: 'Read papers + review week + fill in Hours Log + plan next week', why: 'Consolidation beats new material' },
    { day: 'Sunday', time: '20:00-20:45', hours: 0.75, track: 'B - DSA', what: '1 NeetCode problem', why: 'Daily habit' },
];
...
export const routineRules: string[] = [
    ...
    'Friday 09:00-15:00 is sacred. Then STOP. Friday afternoon and evening are yours.',
...
export interface PlanWeek {
    ...
    phaseKey: PhaseKey;
    targetHours: number;
    /** Track A — mornings: WATCH -> READ -> BUILD. */
    mornings: string;
    /** Friday's 5 hours — build from scratch. */
    friday: string;
    /** Saturday 3.5h — Track B, AI engineering. */
    saturday: string;
...
export const planWeeks: PlanWeek[] = [
    {
        ...
        mornings: "WATCH 3Blue1Brown 'Essence of Linear Algebra' (full series). READ Deisenroth Ch 2. BUILD: matrix ops in NumPy by hand.",
        friday: 'Karpathy Video 1 - build MICROGRAD from nothing. Type every line.',
        saturday: "WATCH Karpathy 'Intro to LLMs' (1hr). Set up GitHub, Colab, Overleaf, W&B accounts.",
    ...
    },
    {
        ...
        phase: 'PHASE 1: Foundations + Autograd', phaseKey: 'foundations', targetHours: FULL,
        mornings: "WATCH 3B1B 'Essence of Calculus'. READ Deisenroth Ch 3-4 (geometry, SVD). BUILD: implement SVD-based PCA yourself.",
        friday: 'Finish micrograd. EXTEND it: add tanh, exp, and one operation of your own design.',
        saturday: 'HuggingFace LLM Course Ch 1-2. Run your first local model.',
        dsa: 'Arrays & Hashing (6-9)',
    },
    {
        week: 3, dates: '31 Aug-6 Sep', startDate: '2026-08-31', endDate: '2026-09-06',
        phase: 'PHASE 1: Foundations + Autograd', phaseKey: 'foundations', targetHours: FULL,
        mornings: "WATCH 3B1B 'Neural Networks' series. READ Deisenroth Ch 5 (vector calculus). BUILD: derive backprop for 2-layer MLP ON PAPER.",
        friday: 'Karpathy Video 2 - makemore 1 (bigrams). Then rewrite it in pure NumPy.',
        saturday: 'HuggingFace LLM Course Ch 3. Fine-tune a small model on Colab.',
    ...
    },
    {
        ...
        mornings: 'No new theory. Review Weeks 1-3. Redo the problems you got wrong.',
        friday: "WRITE + PUBLISH: 'Building an autograd engine from scratch' blog post.",
        saturday: 'Clean up GitHub. Proper READMEs. Make repos look professional.',
    ...
    },
    {
        ...
        mornings: 'WATCH Harvard Stat 110 Lec 1-8 (Blitzstein). READ Murphy Book 1 Ch 2. BUILD: simulate every distribution in NumPy.',
        friday: 'Karpathy Video 3-4 - makemore 2-3 (MLP, activations, BatchNorm internals).',
        saturday: 'Build a simple RAG system: LangChain + a vector DB + your own documents.',
        dsa: 'Sliding Window (all 6)',
    },
    {
        week: 6, dates: '21-27 Sep', startDate: '2026-09-21', endDate: '2026-09-27',
        phase: 'PHASE 2: Probability + Sequence Models', phaseKey: 'probability', targetHours: FULL,
        mornings: 'WATCH Stat 110 Lec 9-16. READ Murphy Ch 3-4. BUILD: implement MLE and Bayesian inference by hand.',
        friday: 'Karpathy Video 5 - makemore 4 (manual backprop through EVERYTHING).',
        saturday: 'Add EVALUATION to your RAG: golden dataset, retrieval metrics, LLM-as-judge. Most people skip this - do not.',
    ...
    },
    {
        ...
        phase: 'PHASE 2: Probability + Sequence Models', phaseKey: 'probability', targetHours: FULL,
        mornings: 'WATCH MacKay lectures (Cambridge, on YouTube). READ MacKay Ch 1-4 (entropy, KL). BUILD: VAE from scratch on MNIST - derive ELBO on paper FIRST.',
        friday: 'Karpathy Video 6 - makemore 5 (WaveNet).',
        saturday: 'Deploy your RAG: FastAPI + Docker + a cloud host. Make it public.',
        dsa: 'Binary Search (all 7)',
    },
    {
        week: 8, dates: '5-11 Oct', startDate: '2026-10-05', endDate: '2026-10-11',
        phase: '*** CONSOLIDATION WEEK ***', phaseKey: 'consolidation', targetHours: LIGHT,
        mornings: 'Review Phases 1-2.',
        friday: 'Publish VAE + LaTeX derivation write-up (learn Overleaf now).',
        saturday: '*** DECIDE YOUR SUBFIELD *** and commit. Interpretability / efficient inference / RLHF / reasoning / multimodal / diffusion.',
    ...
    },
    {
        ...
        mornings: "WATCH Stanford CS336 Lec 1-3 (free on YouTube). READ 'The Annotated Transformer'. BUILD: tokeniser (BPE) from scratch.",
        friday: "Karpathy Video 7 - 'Let's build GPT from scratch'.",
        saturday: 'HuggingFace Agents Course. Build an agent with real tool use.',
    ...
    },
    {
        ...
        phase: 'PHASE 3: Transformers + Learning Theory', phaseKey: 'transformers', targetHours: FULL,
        mornings: 'WATCH CS336 Lec 4-6. READ Shalev-Shwartz Ch 2-6 (PAC learning, VC dimension). BUILD: implement a PAC bound empirically.',
        friday: 'Train your GPT on a real dataset. Get it genuinely working.',
        saturday: 'Add evals + failure-mode analysis to your agent. Document what breaks.',
        dsa: 'Linked List (7-11)',
    },
    {
        week: 11, dates: '26 Oct-1 Nov', startDate: '2026-10-26', endDate: '2026-11-01',
        phase: 'PHASE 3: Transformers + Learning Theory', phaseKey: 'transformers', targetHours: FULL,
        mornings: 'WATCH CS336 Lec 7-9. READ Shalev-Shwartz Ch 7-13 (generalisation bounds). BUILD: reproduce a double-descent curve yourself.',
        friday: "Karpathy - 'Let's reproduce GPT-2 (124M)'.",
        saturday: 'WATCH CS336 systems lectures. Learn Flash Attention, KV cache, quantisation.',
        dsa: 'Trees (1-8)',
    },
    {
        week: 12, dates: '2-8 Nov', startDate: '2026-11-02', endDate: '2026-11-08',
        phase: '*** CONSOLIDATION WEEK ***', phaseKey: 'consolidation', targetHours: LIGHT,
        mornings: 'Review Phase 3.',
        friday: '*** EMAIL YOUR MSc SUPERVISOR *** Plan + GitHub links + ask for guidance and collaboration.',
        saturday: 'Start your literature review doc. Every paper from now goes in with YOUR notes.',
    ...
    },
    {
        ...
        mornings: 'SWITCH: TOEFL prep 2h/day. Official ETS + TST Prep YouTube. Focus WRITING and SPEAKING.',
        friday: 'CHOOSE your reproduction paper. Recent, your subfield, runs on free GPU.',
        saturday: 'Read the paper 5 times. Write every equation by hand.',
        dsa: 'Tries (3) + Heap (1-3)', milestone: 'TOEFL prep starts',
    },
    {
        week: 14, dates: '16-22 Nov', startDate: '2026-11-16', endDate: '2026-11-22',
        phase: 'PHASE 4: Reproduction + TOEFL', phaseKey: 'reproduction', targetHours: FULL,
        mornings: 'TOEFL. Writing daily - this is your weakest area and the most fixable.',
        friday: 'BUILD the reproduction. Get it running end-to-end, even badly.',
        saturday: 'Continue building. Log every experiment in W&B.',
        dsa: 'Heap (4-7)',
    },
    {
        week: 15, dates: '23-29 Nov', startDate: '2026-11-23', endDate: '2026-11-29',
        phase: 'PHASE 4: Reproduction + TOEFL', phaseKey: 'reproduction', targetHours: FULL,
        mornings: 'TOEFL. *** BOOK YOUR EXAM for mid-January *** Booking makes it real.',
        friday: 'DEBUG until your numbers match the paper. This is where real learning happens.',
        saturday: 'vLLM + quantisation. Serve a model efficiently. Measure latency and cost.',
        dsa: 'Backtracking (1-5)', milestone: 'TOEFL booked',
    },
    {
        week: 16, dates: '30 Nov-6 Dec', startDate: '2026-11-30', endDate: '2026-12-06',
        phase: '*** CONSOLIDATION WEEK ***', phaseKey: 'consolidation', targetHours: LIGHT,
        mornings: 'Light TOEFL only. Rest.',
        friday: 'Write the README properly: what matched, what did not, and WHY.',
        saturday: 'Rest. You have done 4 months - protect yourself.',
    ...
    },
    {
        ...
        mornings: 'TOEFL (1h) + newest arXiv in your subfield (1h).',
        friday: 'FIND YOUR EXTENSION: an ablation nobody ran, a failure mode, a simpler method, or a clean negative result.',
        saturday: 'Build project 3: a reusable evaluation pipeline. This is the most hireable skill you can show.',
        dsa: 'Graphs (1-6)',
    },
    {
        ...
        phase: 'PHASE 5: Original Contribution', phaseKey: 'original', targetHours: FULL,
        mornings: 'TOEFL.',
        friday: 'RUN EXPERIMENTS. Log everything. Track every seed.',
        saturday: 'Continue eval pipeline.',
        dsa: 'Graphs (7-13)',
    },
    {
        ...
        mornings: 'TOEFL only. Call your family properly.',
        friday: 'Light work or rest.',
        saturday: 'Write up results AS YOU GO. Never leave writing until the end.',
        dsa: 'Advanced Graphs (1-3)',
    },
    {
        week: 20, dates: '28 Dec-3 Jan', startDate: '2026-12-28', endDate: '2027-01-03',
        phase: '*** CONSOLIDATION WEEK ***', phaseKey: 'consolidation', targetHours: LIGHT,
        mornings: 'Review the whole 5 months.',
        friday: 'Finish experiments. Draft in NeurIPS/ICML LaTeX template.',
        saturday: 'Update CV and LinkedIn with all three projects.',
    ...
    },
    {
        ...
        mornings: 'FINAL TOEFL PREP.',
        friday: 'Polish write-up. Send to your MSc supervisor for feedback.',
        saturday: '*** START APPLYING FOR AI ENGINEER JOBS IN THE UK *** You now have 3 real projects.',
        dsa: '1-D DP (1-6)',
    },
    {
        ...
        phase: 'PHASE 6: Publish, Test, Apply', phaseKey: 'publish', targetHours: FULL,
        mornings: '*** TOEFL EXAM ***',
        friday: 'PUBLISH: arXiv preprint (supervisor endorses) or detailed technical blog + GitHub.',
        saturday: 'Job applications. Mock interviews. Your DSA is now 22 weeks strong.',
        dsa: '1-D DP (7-12)', milestone: 'OUTPUT: TOEFL + published work',
    },
    {
        week: 23, dates: '18-24 Jan', startDate: '2027-01-18', endDate: '2027-01-24',
        phase: 'PHASE 6: Publish, Test, Apply', phaseKey: 'publish', targetHours: FULL,
        mornings: 'Build professor list: 25-30 names, their recent papers, funding, availability.',
        friday: 'Read 3 papers from each of your top 10 professors.',
        saturday: 'Job applications continue.',
        dsa: '2-D DP (1-6)',
    },
    {
        week: 24, dates: '25-31 Jan', startDate: '2027-01-25', endDate: '2027-01-31',
        phase: 'PHASE 6: Publish, Test, Apply', phaseKey: 'publish', targetHours: FULL,
        mornings: 'Draft Statement of Purpose.',
        friday: 'EMAIL PROFESSORS - 5 per week, each personalised. Never generic.',
        saturday: 'Interviews. System design practice.',
        dsa: '2-D DP (7-11)', milestone: 'Outreach begins',
    },
    {
        week: 25, dates: '1-7 Feb', startDate: '2027-02-01', endDate: '2027-02-07',
        phase: 'PHASE 6: Publish, Test, Apply', phaseKey: 'publish', targetHours: FULL,
        mornings: 'Refine SoP. Get it edited by a native speaker.',
        friday: '5 more professor emails.',
        saturday: '*** REQUEST RECOMMENDATION LETTERS *** Give 3 months notice minimum.',
        dsa: 'Greedy (all 8)',
    },
    {
        ...
        mornings: 'Honest review of all 6 months. What worked, what did not.',
        friday: 'Plan next 6 months: GRE if needed, second project, Dec 2027 applications.',
        saturday: 'Rest. You have earned it.',
...
export const resources: Resource[] = [
    { track: 'A - Theory', topic: 'Linear Algebra', watch: "3Blue1Brown 'Essence of Linear Algebra' (YouTube) | MIT 18.06 Strang", read: 'Maths for ML (Deisenroth) Ch 2-4  -  mml-book.github.io', build: 'Implement PCA + SVD in NumPy' },
    { track: 'A - Theory', topic: 'Calculus / Backprop', watch: "3Blue1Brown 'Essence of Calculus' + 'Neural Networks' series", read: 'Deisenroth Ch 5', build: 'Derive backprop on paper, then in NumPy' },
    { track: 'A - Theory', topic: 'Probability', watch: 'Harvard Stat 110 (Blitzstein) - full course on YouTube', read: "Murphy 'Probabilistic ML: Intro' Ch 2-4  -  probml.github.io", build: 'Simulate every distribution yourself' },
    { track: 'A - Theory', topic: 'Information Theory', watch: "David MacKay's Cambridge lectures (YouTube)", read: 'MacKay Ch 1-4  -  inference.org.uk/mackay/itila', build: 'Implement entropy, KL, cross-entropy' },
    { track: 'A - Theory', topic: 'Optimisation', watch: 'Stanford EE364A (Boyd) lectures on YouTube', read: "Boyd 'Convex Optimization'  -  stanford.edu/~boyd/cvxbook", build: 'Implement SGD, Adam from scratch' },
    { track: 'A - Theory', topic: 'Learning Theory', watch: 'Shalev-Shwartz lectures / Cornell CS4780 (Kilian Weinberger)', read: "'Understanding Machine Learning' Ch 2-13", build: 'Reproduce a double-descent curve' },
    { track: 'A - Theory', topic: 'Deep Learning', watch: "Karpathy 'Neural Networks: Zero to Hero' - THE most important series", read: "Bishop 'Deep Learning: Foundations & Concepts' (bishopbook.com)", build: 'micrograd, makemore, nanoGPT' },
    { track: 'A - Theory', topic: 'Transformers', watch: "Stanford CS336 'Language Modeling from Scratch' (free on YouTube)", read: "'The Annotated Transformer' - nlp.seas.harvard.edu", build: 'Build tokeniser + transformer from nothing' },
    { track: 'A - Theory', topic: 'Your subfield', watch: 'Yannic Kilcher paper reviews | conference talks on YouTube', read: "Lilian Weng's blog (lilianweng.github.io) - best surveys anywhere", build: 'Reproduce one paper end to end' },
    { track: 'B - AI Eng', topic: 'LLM Fundamentals', watch: "Karpathy 'Intro to Large Language Models' + '3h LLM deep dive'", read: 'HuggingFace LLM Course - huggingface.co/learn', build: 'Run + fine-tune a local model' },
    { track: 'B - AI Eng', topic: 'AI Engineering', watch: 'MIT 6.S191 (introtodeeplearning.com) | DeepLearning.AI short courses', read: "Chip Huyen 'AI Engineering' (2025) - the standard text", build: '3 portfolio projects (see Projects)' },
    { track: 'B - AI Eng', topic: 'RAG', watch: 'LangChain / LlamaIndex official YouTube tutorials', read: 'LangChain docs + Pinecone learning centre', build: 'Build RAG over your own documents' },
    { track: 'B - AI Eng', topic: 'Agents', watch: 'HuggingFace Agents Course (free, hands-on)', read: "Anthropic 'Building Effective Agents' | LangGraph docs", build: 'Agent with tools + failure analysis' },
    { track: 'B - AI Eng', topic: 'EVALUATION', watch: "DeepLearning.AI eval courses | Hamel Husain's talks", read: "Hamel Husain's blog (hamel.dev) - best eval writing online", build: 'Golden dataset + LLM-as-judge pipeline' },
    { track: 'B - AI Eng', topic: 'Serving / Systems', watch: 'CS336 systems lectures | vLLM official talks', read: "vLLM docs | 'Efficient LLM Inference' surveys", build: 'Deploy with vLLM + quantisation, measure cost' },
    { track: 'B - AI Eng', topic: 'MLOps', watch: 'Full Stack Deep Learning (fullstackdeeplearning.com)', read: 'Made With ML (madewithml.com)', build: 'FastAPI + Docker + cloud deploy' },
    { track: 'B - DSA', topic: 'Patterns + practice', watch: 'NeetCode YouTube - video for all 150 problems', read: 'Tech Interview Handbook - techinterviewhandbook.org', build: 'neetcode.io/practice - 1 problem daily' },
    { track: 'B - DSA', topic: 'Python fluency', watch: 'Corey Schafer Python series (YouTube)', read: 'Fluent Python (Ramalho) - if you want real depth', build: 'Rewrite your old code more cleanly' },
    { track: 'Both', topic: 'TOEFL', watch: 'TST Prep (YouTube) | official ETS videos', read: 'ETS Official Guide', build: 'Write 1 essay per week from Month 4' },
    { track: 'Both', topic: 'LaTeX / writing', watch: 'Overleaf official tutorials (YouTube)', read: "Overleaf docs | 'The Elements of Style'", build: 'Write every project up in LaTeX' },
    { track: 'Both', topic: 'Papers', watch: 'Yannic Kilcher | AI Coffee Break | conference talks', read: 'arxiv.org | paperswithcode.com | connectedpapers.com', build: '3-pass method - see the Papers Log' },
    { track: 'Both', topic: 'Community', watch: '-', read: '-', build: 'Fast.ai Discord | EleutherAI Discord | Leeds/Manchester ML meetups' },
];
